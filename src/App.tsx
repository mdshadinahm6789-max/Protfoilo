...
export default function App() {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    // Simulate real database saving / API Proxy delay
    setTimeout(() => {
    ...
    return (
      <div className="fixed inset-0 z-50 bg-[#0a0f1e] flex flex-col items-center justify-center space-y-6">
        ...
        <div className="text-center space-y-1.5">
          <h2 className="font-display font-bold text-xl text-white tracking-wide">Shadin.</h2>
    ...
    <div className="min-h-screen bg-[#0a0f1e] text-white relative overflow-x-hidden bg-grid-dots selection:bg-[#00d4ff]/35 selection:text-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          >
            Shadin<span className="text-[#00d4ff] text-3xl font-display leading-[0.5] font-extrabold">.</span>
          </a>
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            <div className="space-y-2">
              ...
              <h1 className="font-display font-extrabold text-4xl sm:text-5xl lg:text-6xl text-white tracking-tight leading-[1.1]">
                Md Shahnewaz Hossain Shadin
              </h1>
              <div className="text-xl sm:text-2xl font-sans font-medium text-[#8892b0]">
                And I'm a <TypingText words={['Web Developer', 'Novelist', 'Poet', 'Creative Thinker', 'Freelancer']} />
              </div>
            </div>

            <p className="text-sm sm:text-base text-slate-400 leading-relaxed max-w-xl mx-auto lg:mx-0">
              I weave complex algorithms as a full-stack engineer and narrative verses as a literary poet. Based in Bangladesh, craft belongs to every creative translation.
            </p>

            {/* Circular Social Outline Links */}
            <div className="flex justify-center lg:justify-start gap-4 pt-2">
              {[
                { href: 'https://www.facebook.com/profile.php?id=61584792145726', icon: <Facebook className="w-5 h-5" />, label: 'Facebook' },
                { href: 'https://www.instagram.com/md_shadin_12?igsh=MWFsNnhtbmkyaDB2Zg==', icon: <Instagram className="w-5 h-5" />, label: 'Instagram' }
              ].map((social, i) => (
                <a
                  key={i}
                  href={social.href}
            ...
            <div className="relative animate-float pointer-events-none">
              ...
              <div className="conic-glowing-border h-72 w-72 sm:h-80 sm:w-80 shadow-[0_0_20px_rgba(0,212,255,0.15)] animate-glow-pulse">
                ...
                <div className="w-full h-full rounded-full bg-gradient-to-b from-[#0d1b2a] to-[#0a0f1e] flex flex-col justify-center items-center relative overflow-hidden">
                  ...
                  <img
                    src="https://www.image2url.com/r2/default/images/1781238924109-40d10320-0e98-4a9c-be08-66a3ac8bd142.webp"
                    alt="Md Shahnewaz Hossain Shadin"
        ...
        <section id="about" className="scroll-mt-24 space-y-12">
          ...
          <div className="text-center space-y-2">
            ...
            <h2 className="text-3xl sm:text-4xl font-display font-extrabold text-white tracking-tight">
              About Md Shahnewaz Hossain Shadin
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative group">
                ...
                <div className="relative w-72 h-96 sm:w-80 sm:h-[450px] bg-[#112240] rounded-2xl border border-white/5 shadow-2xl p-6 overflow-hidden flex flex-col justify-between">
                  ...
                  <div className="space-y-5 text-center mt-6">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#00d4ff] to-[#7c3aed] flex items-center justify-center text-[#0a0f1e] mx-auto shadow-lg shadow-cyan-500/10">
                      <Feather className="w-8 h-8 stroke-[1.8]" />
                    </div>

                    <div className="space-y-2">
                      <div className="font-display font-bold text-lg text-white">The Dual Craftsman</div>
                      <p className="text-xs text-slate-400 font-sans max-w-[200px] mx-auto">
                        "Constructing digital solutions while exploring character struggles in human dimensions."
                      </p>
                    </div>
                  </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="text-slate-300 space-y-4 leading-relaxed font-sans text-sm sm:text-base">
                <p>
                  I am <strong className="text-white">Md Shahnewaz Hossain Shadin</strong> — a passionate Web Developer and creative writer based in Bangladesh. I craft digital experiences that are both functionally powerful and visually stunning. With expertise in modern frontend and backend technologies, I transform complex ideas into clean, scalable web solutions.
                </p>
                
                <p>
                  Beyond the world of code, I am a dedicated literary artist. I write <strong className="text-white text-[#7c3aed] font-medium">novels, poetry, and short stories</strong> — weaving words the same way I weave code: with precision, emotion, and purpose. My writing explores the human condition, love, society, and the infinite dimensions of imagination.
                </p>

                {aboutExpanded && (
                  <div className="space-y-4 pt-2 border-t border-white/5 animate-fadeIn">
                    <p>
                      I believe that technology and literature are not opposites — they are two languages for the same truth: <strong className="text-[#00d4ff]">connection</strong>. Whether I'm building a web application or penning a verse, my goal is always the same — to create something that resonates deeply and lasts.
                    </p>
                    <p>
                      Currently available for <strong className="text-white">freelance web development projects</strong> and <strong className="text-white">literary collaborations</strong> worldwide.
                    </p>
                  </div>
                )}
              </div>
        ...
        <section id="projects" className="scroll-mt-24 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProjects.map((project) => (
              ...
              >
                {/* Project Visual Thumbnail Cover */}
                <div className="relative h-44 rounded-xl overflow-hidden mb-5">
                  ...
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 flex items-center justify-center gap-4 transition-all duration-300">
                    <button
                      onClick={() => handleNavLinkClick('contact')}
                      className="p-3 bg-[#0a0f1e]/90 hover:bg-[#00d4ff] text-[#00d4ff] hover:text-[#0a0f1e] rounded-xl transition-all font-mono font-semibold"
                    >
                      <Eye className="w-5 h-5" />
                    </button>
                    <button
                      onClick={() => handleNavLinkClick('contact')}
                      className="p-3 bg-[#0a0f1e]/90 hover:bg-[#7c3aed] text-[#7c3aed] hover:text-white rounded-xl transition-all"
                    >
                  ...
                  <div className="absolute inset-4 flex flex-col justify-between pointer-events-none">
                    <span className="text-[10px] font-mono tracking-widest uppercase bg-black/40 text-[#00d4ff] px-2 py-0.5 rounded-md border border-white/5 self-start">
                      {project.category}
                    </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="space-y-4 font-mono text-xs">
                ...
                <a
                  href="mailto:mdsazzad2151@gmail.com"
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-sm break-all font-sans font-medium text-white/90">mdsazzad2151@gmail.com</span>
                  </div>
                </a>
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-[#112240]/40 border border-white/5 text-[#8892b0]">
                  ...
                  <div>
                    ...
                    <span className="text-sm font-sans font-medium text-white/90">Dhaka, Bangladesh</span>
                  </div>
                </div>
              ...
              <div className="p-6 bg-gradient-to-r from-[#0d1b2a] to-[#112240] rounded-2xl border border-white/5 relative overflow-hidden text-center">
                ...
                <div className="relative z-10 space-y-2">
                  ...
                  <p className="text-[11px] text-slate-400 font-sans">
                    Serving US, Europe, & local collaborative projects.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="space-y-2 text-center md:text-left">
            <span className="font-display text-2xl font-black text-white">
              Shadin<span className="text-[#00d4ff]">.</span>
            </span>
          ...
          <div className="flex flex-col sm:flex-row gap-6 text-center text-xs font-mono text-[#8892b0] tracking-wider">
            <button onClick={() => handleNavLinkClick('about')} className="hover:text-white transition-colors cursor-pointer">About Shadin</button>
          ...
          <div className="text-center md:text-right space-y-1.5">
            <p className="text-xs text-[#8892b0] font-mono">
              © 2026 Md Shahnewaz Hossain Shadin. All Rights Reserved.
            </p>
            <p className="text-[10px] text-slate-500 font-sans tracking-wide">
              Made with ❤️ and ☕ in Bangladesh
            </p>
          </div>
